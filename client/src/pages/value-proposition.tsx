  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground">
        ...
        >
          <div className="mb-12 text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-[hsl(209,100%,36%)] mb-6">
              Delivering Value for Enterprise
            </h1>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-4 leading-relaxed">
                    ...
                    This creates a paradigm shift from a 30-day cycle to a 5-day cycle, ensuring Enterprise can respond to market demands with agility without sacrificing governance.
                  </p>
      ...
      <footer className="py-8 border-t border-border bg-white text-center text-sm text-muted-foreground mt-12">
        <p>© 2026 Enterprise. Strategic Transformation Office.</p>
      </footer>
    </div>
  );
}
