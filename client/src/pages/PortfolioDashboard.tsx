...
import { PortfolioStrategicThemesWidget } from '@/components/widgets/PortfolioStrategicThemesWidget';
import { PortfolioWSJFWidget } from '@/components/widgets/PortfolioWSJFWidget';
import { PortfolioInvestmentHorizonsWidget } from '@/components/widgets/PortfolioInvestmentHorizonsWidget';
...
export default function PortfolioDashboard() {
  ...
  const widgetComponents = {
    ...
    'portfolio-strategic-themes': <PortfolioStrategicThemesWidget />,
    'portfolio-wsjf': <PortfolioWSJFWidget />,
    'portfolio-investment-horizons': <PortfolioInvestmentHorizonsWidget />,
  };
          ...
          <div className="mb-8 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Lean Portfolio Management insights across strategic themes and investment horizons
              </p>
            </div>
          </div>
