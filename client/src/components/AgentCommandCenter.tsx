...
const initialInterventions: RiskIntervention[] = [
  {
    ...
    description: 'Enterprise Data Platform API delivery delayed by 3 sprints, blocking Sustainability Analytics data ingestion.',
    projectId: 'pmo-lgc-002',
    projectName: 'Sustainability Analytics Platform',
    confidence: 94,
