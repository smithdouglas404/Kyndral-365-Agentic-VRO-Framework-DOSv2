...
export async function generateLifecycleInsight(
  ...
  const systemPrompt = `You are the VRO (Value Realization Office) AI agent for the Enterprise Transformation Office. Provide a concise, actionable insight about the project portfolio health based on the metrics provided. Be specific and executive-focused. Keep the response to 2-3 sentences maximum.`;
