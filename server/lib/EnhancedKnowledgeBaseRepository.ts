...
export class EnhancedKnowledgeBaseRepository {
  ...
  async createArticle(
    ...
    await this.storage.db.execute(
      `INSERT INTO enhanced_knowledge_base (
        ...
        relevant_agents, document_type, trigger_conditions, form_schema, required_fields,
  ...
  async deleteArticle(id: string): Promise<void> {
    ...
    console.log(`[EnhancedKB] Deleted article: ${id}`);
  }
  ...
  async updateArticle(
    ...
    await this.storage.db.execute(
      `UPDATE enhanced_knowledge_base SET
        ...
        form_schema = $14, required_fields = $15, metadata = $16,
        embedding = $17, status = $18, updated_at = $19
       WHERE id = $1`,
      [
        updated.id,
        updated.title,
